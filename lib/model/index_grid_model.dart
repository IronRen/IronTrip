...
class GridNavItem {
  ...
  GridNavItem.fromJson(Map<String, dynamic> json) {
    ...
    mainItem = json['mainItem'] != null ? new Item.fromJson(json['mainItem']) : null;
...
class Item {
  ...
  Item({this.title, this.url, this.statusBarColor,this.hideAppBar,this.icon});
...
class SalesBoxModel {
  String icon;
  String moreUrl;
  WelfareCard bigCard1;
  WelfareCard bigCard2;
  WelfareCard smallCard1;
  WelfareCard smallCard2;
  WelfareCard smallCard3;
  WelfareCard smallCard4;
  ...
  SalesBoxModel.fromJson(Map<String, dynamic> json) {
    ...
    bigCard1 = json['bigCard1'] != null
        ? new WelfareCard.fromJson(json['bigCard1'])
        : null;
    bigCard2 = json['bigCard2'] != null
        ? new WelfareCard.fromJson(json['bigCard2'])
        : null;
    smallCard1 = json['smallCard1'] != null
        ? new WelfareCard.fromJson(json['smallCard1'])
        : null;
    smallCard2 = json['smallCard2'] != null
        ? new WelfareCard.fromJson(json['smallCard2'])
        : null;
    smallCard3 = json['smallCard3'] != null
        ? new WelfareCard.fromJson(json['smallCard3'])
        : null;
    smallCard4 = json['smallCard4'] != null
        ? new WelfareCard.fromJson(json['smallCard4'])
        : null;
  }
...
class WelfareCard {
  ...
  WelfareCard({this.icon, this.url, this.title});

  WelfareCard.fromJson(Map<String, dynamic> json) {
    icon = json['icon'];
    url = json['url'];
    title = json['title'];
  }
